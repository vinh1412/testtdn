...
/*
 * @description: Filter to allow only requests coming through the internal gateway or from other services
...
public class GatewayOnlyFilter extends OncePerRequestFilter {
    ...
    // This function specifies which requests will not be filtered.
    @Override
