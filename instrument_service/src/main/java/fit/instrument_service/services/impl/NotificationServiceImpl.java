...
/**
 * @description: Implementation of NotificationService
...
public class NotificationServiceImpl implements NotificationService {
    ...
    // In a real implementation, this would use RabbitMQ or similar messaging system
    
    @Override
    public void notifySampleStatusUpdate(BloodSample sample) {
        log.info("Notification: Sample {} status updated to {}", 
                sample.getBarcode(), sample.getStatus());
