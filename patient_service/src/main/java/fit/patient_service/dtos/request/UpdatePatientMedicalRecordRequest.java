/*
 * @ {#} UpdatePatientMedicalRecordRequest.java   1.0     11/10/2025
 *
...
/*
 * @description: DTO for updating patient medical record
 * @author: Tran Hien Vinh
 * @date:   11/10/2025
 * @version:    1.0
 */
public record UpdatePatientMedicalRecordRequest(
