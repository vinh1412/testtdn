...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AccessLogJsonException.class)
    public ResponseEntity<ErrorResponse> handleAccessLogJsonException(
            AccessLogJsonException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(PatientGenderException.class)
    public ResponseEntity<ErrorResponse> handlePatientGenderException(
            PatientGenderException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(MedicalRecordStatusException.class)
    public ResponseEntity<ErrorResponse> handleMedicalRecordStatusException(
            MedicalRecordStatusException ex, HttpServletRequest request) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage(), HttpStatus.BAD_REQUEST.value());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse(
                        response.getStatus(),
    ...
    @ExceptionHandler(MedicalRecordDoctorIdException.class)
    public ResponseEntity<ErrorResponse> handleMedicalRecordDoctorIdException(
            MedicalRecordDoctorIdException ex, HttpServletRequest request) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage(), HttpStatus.BAD_REQUEST.value());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse(
                        response.getStatus(),
    ...
    @ExceptionHandler(FormatDateException.class)
    public ResponseEntity<ErrorResponse> handleFormatDateException(
            FormatDateException ex, HttpServletRequest request) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage(), HttpStatus.BAD_REQUEST.value());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse(
                        response.getStatus(),
    ...
    @ExceptionHandler(PatientMedicalRecordAlreadyExistsException.class)
    public ResponseEntity<ErrorResponse> handlePatientMedicalRecordAlreadyExistsException(
            PatientMedicalRecordAlreadyExistsException ex, HttpServletRequest request) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage(), HttpStatus.CONFLICT.value());
        return ResponseEntity.status(HttpStatus.CONFLICT).body(
                new ErrorResponse(
                        response.getStatus(),
    ...
    public ResponseEntity<ErrorResponse> handleGenderException(
            GenderException ex, HttpServletRequest request) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage(), HttpStatus.BAD_REQUEST.value());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse(
                        response.getStatus(),
    ...
    public ResponseEntity<ErrorResponse> handleNotEmptyException(
            NotEmptyException ex, HttpServletRequest request) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage(), HttpStatus.BAD_REQUEST.value());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse(
                        response.getStatus(),
